...
<html lang="es">
    <head>
        ...
        <title>Fenix - Redes y más</title>
        <!-- Favicons-->
        <link rel="icon" href="{{URL::asset('img/fenix.png" sizes="32x32')}}">
        <!-- Favicons-->
        <link rel="apple-touch-icon-precomposed" href="{{URL::asset('img/fenix.png')}}">
        <!-- For iPhone -->
        <meta name="msapplication-TileColor" content="#00bcd4">
        <meta name="msapplication-TileImage" content="{{URL::asset('img/fenix.png')}}">
        <!-- For Windows Phone -->
...
<body class="theme-blush pricing_page box_layout particles_js">

    <!-- Page Loader -->
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img src="{{URL::asset('img/fenix.png')}}" width="40" height="40" alt="Fenix"></div>
            <p>Cargando...</p>
        </div>
    </div>
    ...
    <div id="wrapper">
            ...
            <div class="container">
                <div class="navbar-left">
                    <div class="navbar-btn">
                        <a href="index.html"><img src="{{URL::asset('img/fenix.png')}}" alt="Fenix Logo" class="img-fluid logo"></a>
                ...
                <div class="navbar-right">
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav">
                            <li><a href="{{url('/')}}" class="social icon-menu" title="Home">Inicio</a></li>
                            <li><a href="{{url('/plans_packages')}}" class="news icon-menu" title="Plans and packages">Planes y paquetes</a></li>
                            <li><a href="javascript:void(0);" class="megamenu_toggle icon-menu" title="Coverage">Cobertura</a></li>
                            <li><a href="{{url('/plans_packages')}}" class="news icon-menu" title="About us">Acerca de</a></li>
                        <!--<li class="dropdown">
                                ...
                                <ul class="dropdown-menu right_chat email vivify fadeIn">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object " src="<?php /*echo URL */?>Public/images/xs/avatar4.jpg" alt="">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object " src="<?php /*echo URL */?>Public/images/xs/avatar1.jpg" alt="">
                                                <div class="media-body">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media">
                                                <img class="media-object " src="<?php /*echo URL */?>Public/images/xs/avatar5.jpg" alt="">
                                                <div class="media-body">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <div class="media mb-0">
                                                <img class="media-object " src="<?php /*echo URL */?>Public/images/xs/avatar2.jpg" alt="">
                                                <div class="media-body">
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{URL::asset('images/image-gallery/7.jpg')}}" alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{URL::asset('images/image-gallery/8.jpg')}}" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{URL::asset('images/image-gallery/9.jpg')}}" alt="Third slide">
                                    </div>
                                </div>
                ...
                <div class="chat_detail vivify fadeIn delay-100">
                    ...
                    <ul class="chat-widget clearfix">
                        <li class="left float-left">
                            <img src="{{URL::asset('images/xs/avatar2.jpg')}}" class="rounded" alt="">
                            <div class="chat-info">
                                <span class="message">Hello, John<br>What is the update on Project X?</span>
                            </div>
                        </li>
                        <li class="right">
                            <img src="{{URL::asset('images/xs/avatar1.jpg')}}" class="rounded" alt="">
                            <div class="chat-info">
                ...
                <div class="chat_list">
                    ...
                    <ul class="right_chat list-unstyled mb-0">
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object" src="{{URL::asset('images/xs/avatar4.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{URL::asset('images/xs/avatar5.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{URL::asset('images/xs/avatar2.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{URL::asset('images/xs/avatar1.jpg')}}" alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{URL::asset('images/xs/avatar3.jpg')}}" alt="">
                                    <div class="media-body">
        ...
        <div id="left-sidebar" class="sidebar">
            <div class="navbar-brand">
                <a href="index.html"><img src="{{URL::asset('img/fenix.png')}}" alt="Fenix Logo" class="img-fluid logo"><span>Fenix</span></a>
                <button type="button" class="btn-toggle-offcanvas btn btn-sm float-right"><i class="lnr lnr-menu fa fa-chevron-circle-left"></i></button>
            </div>
            <div class="sidebar-scroll">
                <div class="user-account">
                    <div class="user_div">
                        <img src="{{URL::asset('images/user.png')}}" class="user-photo" alt="User Profile Picture">
                    </div>
                    <div class="dropdown">
                        <span>Welcome,</span>
